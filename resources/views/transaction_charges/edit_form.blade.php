        ...
        <div class="row">
            ...
            <div class="col-md-12 breadcrumb-margin" >
                ...
                <div class="col-md-12">
                    ...
                    {{ Breadcrumbs::render('transaction-charges-update') }}
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                @endforeach
                    ...
                    <form method='post' action="{{ route('transaction_charges.update', $charge->id) }}">
                        <from class="form-horizontal">
                            ...
                            <div class="form-body">
                                    ...
                                    <label class="col-md-12"> Enter the transaction Charge</label>
                                    <div class="col-md-12 m-b-20">
                                        <input type="number" class="form-control" value="{{ $charge->charge }}" min="0" name="charge" required />
                                    </div>
                            </div>
