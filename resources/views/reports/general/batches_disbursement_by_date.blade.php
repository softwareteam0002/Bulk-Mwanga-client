...
@section('content')
    ...
    <div class="container concustom-report-container">
        <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-outline-info">
                <form method="post" action="{{url('reports/general/disbursement-by-date')}}">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        @if(!empty($batchPayment))
                                            <select type="text" name="type" required class="form-control type">
                                                ...
                                                <!-- <option value="40" @if($type==40)
                                                    selected

                                                @endif>All In One With Running Balance</option>  -->
                                            </select>
                                        @else
                                            <select type="text" name="type" required class="form-control type">
                                                <option selected disabled>Select Type</option>
