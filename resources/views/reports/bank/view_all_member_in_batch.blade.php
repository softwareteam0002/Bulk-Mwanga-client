...
{{--                      todo list return user batch alone.--}}
                      <td>Batch Number</td><td class="red-color">{{$user_batch_no}}</td>
                  </tr>
                  <tr>
                      <td>Entries</td><td><b>{{$entries}}</b></td>
                  </tr>

                  <tr>
                      <td>Total Amount</td><td ><b>{{number_format($amount)}} Tsh</b> </td>
                  </tr>
                  <tr>
                      <th>Batch status</th> <td><b>{{$status_name}}</b></td>
                  </tr>
                  </tbody>
              </table>

                 <div class="form-row">
                     <form action="{{url('reports/bank/payment/batch-payment-per-batch',encrypt($batch_no))}}" method="post">
                     ...
                     <div class="col-md-6">
                         ...
                         <button class="btn btn-danger fa fa-download" name="excel"><span style="margin-left: 5px;">Excel</span></button>
                         <button class="btn btn-danger fa fa-download" name="csv"><span style="margin-left: 5px;">Csv</span></button>
...
@section('js')
    ...
    <script>
        ...
        // $('.report-back').click(function (evt) {
        //
        //     // evt.preventDefault();
        //     history.back();
        // })
