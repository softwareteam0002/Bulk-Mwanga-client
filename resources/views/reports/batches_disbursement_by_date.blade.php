    ...
    <div class="container custom-report-container">
        ...
        <div class="col-md-12">
            <div class="card card-outline-info">
                <form method="post" action="{{url('reports/disbursement-by-date')}}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(!empty($batchPayment))
                                            ...
                                            <input placeholder="End Date" required type="text" name="endDate" id="role-name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if(!empty($batchPayment))
                                                ...
                                                <select name="organization" required id="role-name"
                                                    ...
                                                    <option value="{{\App\Models\ConstantHelper::ALL_ORGANIZATION_GET_REPORT}}">
                                                        All Organizations
                                                    </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(!empty($batchPayment))
                                            <select type="text" name="type" required class="form-control type">
                                                ...
                                                <option value="40" @if($type==40) selected @endif>All In One With Running
                                                    Balance
                                                </option>
                                            </select>
                                        ...
                                        @else
                                            <select type="text" name="type" required class="form-control type">
                                                ...
                                                <option value="30">With Multiple Batches</option>
            ...
            <div class="result-multiple">
                ...
                @if(!empty($batchPayment))
                    ...
                    <form action="{{url('reports/disbursement-by-date-export/multiple')}}" method="post">

                        {{csrf_field()}}

                        {{--<button class="btn btn-danger" name="pdf">Pdf</button>--}}

                        @if(!count($batchPayment)>0)
