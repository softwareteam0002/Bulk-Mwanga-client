...
<head>
    ...
    <title>MHB Disbursement Portal: Recover Password</title>
...
<div class="login-box">
    ...
    <form method="post" action="{{ route('reset_link') }}" class="mt-3">
        {{ csrf_field() }}
        <div class="form-group">
            <input type="email" name="email" class="form-control" placeholder="Email Address" required>
        </div>
        <button type="submit" class="btn login-btn">Send Recovery Email <i class="fa fa-envelope"></i></button>
    </form>
    <!-- Logout to Home -->
