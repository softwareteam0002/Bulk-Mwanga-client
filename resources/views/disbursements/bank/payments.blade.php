...
@section('content')
    <!-- Modal -->
    <div class="modal fade" id="approveBankModal" tabindex="-1" aria-labelledby="approveBankModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="approveBankModalLabel">Warning</h5>
    ...
    <!-- Modal -->
    <div class="modal fade" id="rejectBankModal" tabindex="-1" aria-labelledby="rejectBankModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="rejectBankModalLabel">Warning</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{url('help/batch-reject')}}" method="post">
                    ...
                    <input type="hidden" name="transactionType" value="bank" id="transactionType">
                        ...
                        <tr data-batch-number="{{$data->batch_no}}">
                            ...
                            <td>
                                ...
                                @if($data->batch_status_id==\App\Models\Batch::STATUS_PENDING)
                                    ...
                                    <!--<button  type="button"  id="{{encrypt($data->batch_no)}}" class="btn btn-danger btn-sm  fa fa-check tooltip-voda approve-payment-modal">
                                    ...
                                    <button type="button" data-batch-no="{{encrypt($data->batch_no)}}"
                                            ...
                                            data-toggle="modal" data-target="#approveBankModal">

                                    </button>

                                    {{--                                        </form>--}}

                                    <!-- <button  type="button"  id="{{encrypt($data->batch_no)}}" class="btn btn-danger btn-sm  fa fa-remove tooltip-voda reject-payment">
                                                <span class="tooltip-text">Reject Batch</span>

                                            </button>-->
                                    <button type="button" data-batch-no="{{encrypt($data->batch_no)}}"
                                            class="btn btn-danger btn-sm  fa fa-remove tooltip-voda reject-payment"
                                            data-toggle="modal" data-target="#rejectBankModal">
