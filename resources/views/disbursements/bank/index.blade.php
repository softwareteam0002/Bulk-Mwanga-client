...
@section('content')
    <!-- Modal -->
    <div class="modal fade" id="verifyBankModal" tabindex="-1" aria-labelledby="verifyBankModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="verifyBankModalLabel">Warning</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="yesBankVerify" class="btn btn-danger">Yes</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tr data-batch-number="{{$data->batch_no}}">
                            ...
                            <td>
                                ...
                                @if($data->batch_status_id==\App\Models\Batch::STATUS_PENDING)
                                    <!--<a href="#" onclick="verifyBatch('{{url('bank-disbursement/bankname-search-request',$data->batch_no)}}')"  class=" btn btn-sm btn-danger tooltip-voda fa fa-check ">
