    ...
    <div class="container" style="background-color: white; margin-top: 20px">
        ...
        <div class="row">
            ...
            <div class="col-md-12 breadcrumb-margin">
                ...
                {{ Breadcrumbs::render('organization-users') }}
            ...
            <div class="col-md-12">
                ...
                <div>
                    ...
                    @if(\Illuminate\Support\Facades\Auth::user()->user_type==2)
                        ...
                        <a href="{{url('/organization/users/create')}}" class="btn btn-success btn-regi-organization">Create
                            New User</a>
                ...
                <table class="table table-striped table-bordered" id="table">
                    ...
                    <tr style="background-color: #E60100; color: white;">
                        <th colspan="12">
                            ...
                            <h4 style="color: white">Organization Name: <b>{{$name}}</b></h4>
                    ...
                    @foreach($users as $index=>$user)
                        <tr>
                            ...
                            <td>
                                @if(\App\Models\Permission::canCreateOrganizationUser())

                                    <a href="{{route('organization-user-edit',[$user->id,$organizationId])}}"
                                ...
                                @endif
                                <a href="{{url('organization/users/view',encrypt($user->id))}}"
                                   class=" btn btn-danger fa fa-eye tooltip-voda">
                                    <span class="tooltip-text">View User</span>

                                </a>

                                @if(\App\Models\Permission::organizationChecker())
