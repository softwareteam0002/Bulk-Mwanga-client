...
class ExportVerification implements FromCollection,WithHeadings,WithEvents,WithColumnFormatting
{
    use Exportable;
    ...
    {
        $this->verifications = DB::table('batches as bv');
        ...
        $this->verifications = $this->verifications->select(
            ...
            ->join('disbursements as dp','dp.batch_no','=','bv.batch_no')
            ->get();
