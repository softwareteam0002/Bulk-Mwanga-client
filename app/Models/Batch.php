...
/* class that manage all verification batches*/
...
class Batch extends Model
{
	...
	const STATUS_INSUFFICIENT_BALANCE = 9;
    ...
    public static function getStatusName($status)
    {
        return [
            ...
            Batch::STATUS_ON_HOLD => 'Insuffient balance',
			Batch::STATUS_INSUFFICIENT_BALANCE => 'Insufficient balance',
