...
class SimulatorController extends Controller
{
    ...
    const KYC_CALLBACK_URL = 'http://localhost/projects/disbursement-voda/kyc-callback';
    const DISBURSEMENT_CALLBACK_URL = 'https://uat.ubx.co.tz:8888/mhb_external-disbursement/disbursement-callback';
    const DISBURSEMENT_CALLBACK_BALANCE_URL = 'http://localhost/projects/disbursement-voda/balance-check-callback';
    ...
    private function guessNetwork($MSISDN)
    {
        ...
        $networks = ['AIRTEL', 'YAS', 'HALOTEL', 'TTCL'];
