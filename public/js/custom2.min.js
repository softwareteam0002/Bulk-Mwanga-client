$(function () {
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function () {
        ...
        i(o).each(function () {
            var e = i(this), s = e.closest(".card"), o = s.find(".card-block"), r = {toggle: !1};
            ...
            e.preventDefault();
            var s = i(this).closest(".card"), o = s.find(".card-block");
            o.collapse("toggle")
        })
...
window.addEventListener("load", function () {
    ...
    var close = document.getElementById("o-close");
    ...
    close.addEventListener("click", function () {
        ...
        if (window.sessionStorage){
            window.sessionStorage.setItem("accepted-legal-banner",1)
        }
    });

    if (window.sessionStorage && window.sessionStorage.getItem("accepted-legal-banner")==1){
        close.click();
    }
});
